...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/newtab.scss":
/*!**************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/newtab.scss ***!
  \**************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function createClass(debugName) {
  return ReasonReactOptimizedCreateClass.createClass({
    ...
    subscriptions: null,
    self: function self(state, retainedProps) {
      var $$this = this;
      return (/* record */[
    ...
    transitionNextTotalState: function transitionNextTotalState(curTotalState, reasonStateUpdate) {
      if (typeof reasonStateUpdate === "number") {
        return (/* tuple */[undefined, curTotalState]
        );
      } else {
        switch (reasonStateUpdate.tag | 0) {
          ...
          case 1:
            return (/* tuple */[reasonStateUpdate[0], curTotalState]
            );
          case 2:
            return (/* tuple */[reasonStateUpdate[1], {
                reasonState: reasonStateUpdate[0]
              }]
            );
    ...
    shouldComponentUpdate: function shouldComponentUpdate(nextJsProps, nextState, _) {
      var $$this = this;
      var thisJs = this;
    ...
    onUnmountMethod: function onUnmountMethod(subscription) {
      var $$this = this;
      var match = $$this.subscriptions;
      if (match !== null) {
    ...
    handleMethod: function handleMethod(callback) {
      var $$this = this;
      var thisJs = this;
    ...
    sendMethod: function sendMethod(action) {
      var $$this = this;
      var thisJs = this;
      var convertedReasonProps = convertPropsIfTheyreFromJs(thisJs.props, thisJs.jsPropsToReason, debugName);
      var component = convertedReasonProps[0];
...
function wrapJsForReason(reactClass, props, children) {
  var jsElementWrapped = function jsElementWrapped(param, param$1) {
...
function watchUrl(callback) {
  var match = typeof window === "undefined" ? undefined : window;
  if (match !== undefined) {
    var watcherID = function watcherID() {
...
__webpack_require__(/*! ./newtab.scss */ "./src/newtab.scss");

var _react = __webpack_require__(/*! react */ "./node_modules/react/index.js");

var _react2 = _interopRequireDefault(_react);

var _ListContainer = __webpack_require__(/*! ./ListContainer */ "./src/ListContainer.js");
...
var _ListItem = __webpack_require__(/*! ./ListItem */ "./src/ListItem.js");
...
var ExportTabs = __webpack_require__(/*! ./ExportTabs.bs */ "./src/ExportTabs.bs.js").jsComponent;
...
var ListContainer = function (_Component) {
  ...
  _createClass(ListContainer, [{
    ...
    value: function componentDidMount() {
      ...
      chrome.storage.local.get("tabs", function (result) {
        ...
        if (resultsUndefined) {
          ...
          var noTabs = result.tabs === null || result.tabs === undefined || result.tabs.length === 0 ? true : false;
          if (noTabs) {
    ...
    key: "getCurrentBrowserTabs",
    value: function getCurrentBrowserTabs() {
      var _this4 = this;
    ...
    value: function searchTabs(stringId) {
      if (this.state.tabsWithIds !== null) {
        ...
        var indexToRemove = copy.findIndex(function (urlObj, index) {
          var id = urlObj.tabId;
          var passCondition = id === parseInt(stringId);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "buttonGrp" },
          _react2.default.createElement(ExportTabs, { tabsData: this.state.allTabs }),
          _react2.default.createElement(
            "button",
            { onClick: function onClick() {
...
_reactDom2.default.render(_react2.default.createElement(_App2.default, { message: "alex" }), document.getElementById("root"));
...
var content = __webpack_require__(/*! !../node_modules/mini-css-extract-plugin/dist/loader.js!../node_modules/css-loader!../node_modules/sass-loader/lib/loader.js!./newtab.scss */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/newtab.scss");
