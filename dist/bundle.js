...
var Reason = __webpack_require__(/*! ./Reason.bs */ "./src/Reason.bs.js").jsComponent;
...
var ListContainer = function (_Component) {
  ...
  _createClass(ListContainer, [{
    ...
    value: function renderList() {
      var data = null;
      var noTabs = this.state.allTabs === 0 || this.state.allTabs === null || this.state.allTabs === undefined ? true : false;
      if (noTabs) {
        this.saveTabs();
        var _data = _react2.default.createElement(
          "p",
          null,
          "no tabs to show"
        );
